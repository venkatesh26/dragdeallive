...
<?php
    ...
    <!-- script
    ================================================== -->
    <script src="<?php echo base_url();?>assets/js/trans/modernizr.js"></script>
    <script src="<?php echo base_url();?>assets/js/trans/pace.min.js"></script>
        ...
        <nav class="header-nav">
            ...
            <div class="header-nav__content">
                ...
                <ul class="header-nav__list">
					...
					<li><a class="smoothscroll"  href="#works" title="works">Login</a></li>
    ...
    <section id="home" class="s-home target-section" data-parallax="scroll" data-image-src="images/hero-bg.jpg" data-natural-width=3000 data-natural-height=2000 data-position-y=top>
        ...
        <div class="home-content">
            ...
            <div class="row home-content__main">
                ...
                <p>
                We create stunning short URL experiences <br>
    ...
    <section id='about' class="s-about">
        ...
        <div class="row section-header" data-aos="fade-up">
            <div class="col-full">
                ...
                <h1 class="display-1">We are a group of design driven individuals passionate about creating beautiful pretty Short URL.</h1>
            </div>
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></span> 
    ...
    <!-- Java Script
    ================================================== -->
    <script src="<?php echo base_url();?>assets/js/trans/jquery-3.2.1.min.js"></script>
    <script src="<?php echo base_url();?>assets/js/trans/plugins.js"></script>
    <script src="<?php echo base_url();?>assets/js/trans/main.js"></script>
</body>
</html>