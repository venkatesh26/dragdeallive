...
$(function() {
	if($('.dashboard-remainder-chart').length) {
		
		drawSmsNewRemCampaignChart();
	}
	
	 function drawSmsNewRemCampaignChart() {

		var chart_data;
		var sms_chart_histroy_url=__cfg('path_absolute')+'customers/sms_remainder_histroy';
	
		$.ajax({
				type: "POST",
				url: sms_chart_histroy_url,
				datatype:"json",
				success: function(json)
				{
					var dataDownloads=jQuery.parseJSON(json);
					if(dataDownloads==''){
					   $('.no_remainder_data').show();	
					}
					Morris.Bar({
   ...
   function drawremtodaySmsInfo(){ 
		if (!$('#dashboard-rem-today-sms-send').length) {
			return false;
		}
		var sms_left=$('#dashboard-rem-today-sms-send').attr('rel');
		var chart_data=[{"label":"Today Send Sms","value":sms_left,"data":"20"}];	
		if(sms_left==0) {
			$('.no_today_smsfound_view').show();
			$('.no_today_smsfound_view').css({'color': 'red','text-align': 'center','display':' block', 'margin-top': '50px'});	
		}
		else {		
			Morris.Donut({
			element: 'dashboard-rem-today-sms-send',
			data: chart_data,
			resize: true,
			colors: [
				tinycolor(config.chart.colorPrimary.toString()).lighten(10).toString(),
			...
			var $sameheightContainer = $('#dashboard-rem-today-sms-send').closest(".sameheight-container");
			setSameHeights($sameheightContainer);
}

function drawremMonthSmsInfo(){ 
	if (!$('#dashboard-month-total-sms-send').length) {
		return false;
	}
	var sms_left=$('#dashboard-month-total-sms-send').attr('rel');
	var chart_data=[{"label":"Current Month Send Sms","value":sms_left,"data":"20"}];	
	if(sms_left==0) {
		$('.no_month_view').show();
		$('.no_month_view').css({'color': 'red','text-align': 'center','display':' block', 'margin-top': '50px'});	
	}
	else {		
		Morris.Donut({
		element: 'dashboard-month-total-sms-send',
		data: chart_data,
		resize: true,
		colors: [
			tinycolor(config.chart.colorPrimary.toString()).lighten(10).toString(),
	...
	var $sameheightContainer = $('#dashboard-month-total-sms-send').closest(".sameheight-container");
	setSameHeights($sameheightContainer);
}

function drawremYesterdaySmsInfo(){
		if (!$('#dashboard-rem-yesterday-chart').length) {
			return false;
		}
		var sms_left=$('#dashboard-rem-yesterday-chart').attr('rel');
		var chart_data=[{"label":"Yesterday Send Sms","value":sms_left,"data":"20"}];	
		if(sms_left==0) {
			$('.no_yesterday_view').show();
			$('.no_yesterday_view').css({'color': 'red','text-align': 'center','display':' block', 'margin-top': '50px'});	
		}
		else {		
			Morris.Donut({
			element: 'dashboard-rem-yesterday-chart',
			data: chart_data,
			resize: true,
			colors: [
				tinycolor(config.chart.colorPrimary.toString()).lighten(10).toString(),
		...
		var $sameheightContainer = $('#dashboard-rem-yesterday-chart').closest(".sameheight-container");
		setSameHeights($sameheightContainer);
}

drawremtodaySmsInfo();	
drawremMonthSmsInfo();
drawremYesterdaySmsInfo();
});
...
$(function() {
    ...
    function switchHistoryCharts(item) {
        ...
        switch(item){
            case 'visits':
				drawSmsCampaignChart();
                break;
             case 'downloads':
				drawSmsRemCampaignChart();
                break;
        }
    }
    ...
    function drawSmsRemCampaignChart() {
    ...
    function drawSmsCampaignChart(){ 
		var chart_data;
		var sms_chart_histroy_url=__cfg('path_absolute')+'customers/sms_chart_histroy';
...
$(function() {
	...
	var $dashboardSalesBreakdownChart1 = $('#dashboard-sales-breakdown-chart1');
	var $dashboardSalesBreakdownChart2 = $('#dashboard-sales-breakdown-chart2');
	
  
    function drawtodayViewsChart() {
	...
	$.ajax({
				...
				success: function(data)
				{
					...
					if(data=='null')
					{
						chart_data=[{"label":"No view Yet","value":"","data":""}];	
						$('.no_today_view').show();		
						$('.no_today_view').css({'color': 'red','text-align': 'center','display':' block'});						
					}
					else{
						Morris.Donut({
    ...
    $dashboardSalesBreakdownChart1.empty();
	...
	$.ajax({
				...
				success: function(data)
				{
					...
					if(data=='null')
					{
						chart_data=[{"label":"No view Yet","value":"1","data":"1"}];	
						$('.no_total_view').show();		
						$('.no_total_view').css({'color': 'red','text-align': 'center','display':' block'});								
					}
					else {
							Morris.Donut({
							element: 'dashboard-sales-breakdown-chart1',
							data: chart_data,
							resize: true,
							colors: [
								tinycolor(config.chart.colorPrimary.toString()).lighten(10).toString(),
							...
							var $sameheightContainer = $dashboardSalesBreakdownChart1.closest(".sameheight-container");
							setSameHeights($sameheightContainer);
					}
				}
	     });
    ...
    if (!$dashboardSalesBreakdownChart1.length) {
        return false;
    } 
	else {
		drawtotalViewsChart();
	...
	function drawtopPlatFormsChart(){
    $dashboardSalesBreakdownChart2.empty();
	var total_views_url=__cfg('path_absolute')+'customers/topPlatForms';
	$.ajax({
				type: "POST",
				url: total_views_url,
				datatype:"json",
				...
				{
					chart_data=jQuery.parseJSON(data);
					if(chart_data=='null' || chart_data=='')
					{
						chart_data=[{"label":"No view Yet","value":"","data":""}];
						$('.no_platform_view').show();		
						$('.no_platform_view').css({'color': 'red','text-align': 'center','display':' block'});						
					}
					else {
						Morris.Donut({
						element: 'dashboard-sales-breakdown-chart2',
						data: chart_data,
						resize: true,
						colors: [
							tinycolor(config.chart.colorPrimary.toString()).lighten(10).toString(),
						...
						var $sameheightContainer = $dashboardSalesBreakdownChart2.closest(".sameheight-container");
						setSameHeights($sameheightContainer);
					}
				}
	     });
	...
	function drawSmsInfo(){ 
		
		if (!$('#dashboard-sms-chart').length) {
			return false;
		}
		var sms_left=$('#dashboard-sms-chart').attr('rel');
		var chart_data=[{"label":"SMS Left","value":sms_left,"data":"20"}];	
		if(sms_left==0) {
			$('.no_smsfound_view').show();
			$('.no_smsfound_view').css({'color': 'red','text-align': 'center','display':' block', 'margin-top': '50px'});	
		}
		else {		
			Morris.Donut({
			element: 'dashboard-sms-chart',
			data: chart_data,
			resize: true,
			colors: [
				tinycolor(config.chart.colorPrimary.toString()).lighten(10).toString(),
    ...
    if (!$dashboardSalesBreakdownChart2.length) {
        return false;
    }
    else {
		drawtopPlatFormsChart();
	}	
})
$(function() {
function drawtodaySmsInfo(){ 
		if (!$('#dashboard-today-sms-send').length) {
			return false;
		}
		var sms_left=$('#dashboard-today-sms-send').attr('rel');
		var chart_data=[{"label":"Today Send Sms","value":sms_left,"data":"20"}];	
		if(sms_left==0) {
			$('.no_today_smsfound_view').show();
			$('.no_today_smsfound_view').css({'color': 'red','text-align': 'center','display':' block', 'margin-top': '50px'});	
			...
			Morris.Donut({
			element: 'dashboard-today-sms-send',
			data: chart_data,
			resize: true,
			colors: [
				tinycolor(config.chart.colorPrimary.toString()).lighten(10).toString(),
			...
			var $sameheightContainer = $('#dashboard-today-sms-send').closest(".sameheight-container");
			setSameHeights($sameheightContainer);
	}
drawtodaySmsInfo();


    function drawMonthTotalSmsInfo(){ 
		if (!$('#dashboard-lastmonth-total-sms-send').length) {
			return false;
		}
		var sms_left=$('#dashboard-lastmonth-total-sms-send').attr('rel');
		var chart_data=[{"label":"Month Send Sms","value":sms_left,"data":"20"}];	
		if(sms_left==0) {
			$('.no_month_view').show();
			$('.no_month_view').css({'color': 'red','text-align': 'center','display':' block', 'margin-top': '50px'});	
		}
			...
			Morris.Donut({
			element: 'dashboard-lastmonth-total-sms-send',
			data: chart_data,
			resize: true,
			colors: [
				tinycolor(config.chart.colorPrimary.toString()).lighten(10).toString(),
		...
		var $sameheightContainer = $('#dashboard-lastmonth-total-sms-send').closest(".sameheight-container");
		setSameHeights($sameheightContainer);
	}
drawMonthTotalSmsInfo();		
	
function drawTotalSmsInfo(){ 
	
		if (!$('#dashboard-total-sms-send').length) {
			return false;
		}
		var sms_left=$('#dashboard-total-sms-send').attr('rel');
		var chart_data=[{"label":"Total Send Sms","value":sms_left,"data":"20"}];	
		if(sms_left==0) {
			$('.no_total_smsfound_view').show();
			$('.no_total_smsfound_view').css({'color': 'red','text-align': 'center','display':' block', 'margin-top': '50px'});	
		}
		else {		
			Morris.Donut({
			element: 'dashboard-total-sms-send',
			data: chart_data,
			resize: true,
			colors: [
				tinycolor(config.chart.colorPrimary.toString()).lighten(10).toString(),
		...
		var $sameheightContainer = $('#dashboard-total-sms-send').closest(".sameheight-container");
		setSameHeights($sameheightContainer);
	}
	drawTotalSmsInfo();	
})
...
$(function () {
	...
	*************************************************/
	...
	function getThemeSettings() {
		...
		settings.sidebarPosition = settings.sidebarPosition || 'sidebar-fixed';
