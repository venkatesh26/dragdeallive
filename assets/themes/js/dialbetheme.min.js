...
(function(a){a.fn.supersubs=function(b){var c=a.extend({},a.fn.supersubs.defaults,b);return this.each(function(){var b=a(this),e=a.meta?a.extend({},c,b.data()):c,g=a('<li id="menu-fontsize">&#8212;</li>').css({padding:0,position:"absolute",top:"-999em",width:"auto"}).appendTo(b).width();a("#menu-fontsize").remove();$ULs=b.find("ul");$ULs.each(function(b){b=$ULs.eq(b);var c=b.children(),d=c.children("a"),q=c.css("white-space","nowrap").css("float"),z=b.add(c).add(d).css({"float":"none",width:"auto"}).end().end()[0].clientWidth/
g,z=z+e.extraWidth;z>e.maxWidth?z=e.maxWidth:z<e.minWidth&&(z=e.minWidth);z+="em";b.css("width",z);c.css({"float":q,width:"100%","white-space":"normal"}).each(function(){var b=a(">ul",this),c=void 0!==b.css("left")?"left":"right";b.css(c,z)})})})};a.fn.supersubs.defaults={minWidth:9,maxWidth:25,extraWidth:0}})(jQuery);
(function(a){a.fn.hoverIntent=function(b,c,d){var e={interval:100,sensitivity:7,timeout:0},e="object"===typeof b?a.extend(e,b):a.isFunction(c)?a.extend(e,{over:b,out:c,selector:d}):a.extend(e,{over:b,out:b,selector:c}),g,k,f,p,q=function(a){g=a.pageX;k=a.pageY},z=function(b,c){c.hoverIntent_t=clearTimeout(c.hoverIntent_t);if(Math.abs(f-g)+Math.abs(p-k)<e.sensitivity)return a(c).off("mousemove.hoverIntent",q),c.hoverIntent_s=1,e.over.apply(c,[b]);f=g;p=k;c.hoverIntent_t=setTimeout(function(){z(b,c)},
e.interval)};b=function(b){var c=jQuery.extend({},b),d=this;d.hoverIntent_t&&(d.hoverIntent_t=clearTimeout(d.hoverIntent_t));"mouseenter"==b.type?(f=c.pageX,p=c.pageY,a(d).on("mousemove.hoverIntent",q),1!=d.hoverIntent_s&&(d.hoverIntent_t=setTimeout(function(){z(c,d)},e.interval))):(a(d).off("mousemove.hoverIntent",q),1==d.hoverIntent_s&&(d.hoverIntent_t=setTimeout(function(){d.hoverIntent_t=clearTimeout(d.hoverIntent_t);d.hoverIntent_s=0;e.out.apply(d,[c])},e.timeout)))};return this.on({"mouseenter.hoverIntent":b,
...
p=function(b){b.hasClass(e.menuClass)&&a.error("Superfish requires you to update to a version of hoverIntent that supports event-delegation, such as this one: https://github.com/joeldbirch/onHoverIntent");b=b.closest("."+e.menuClass)[0];d.op=d.o[b.serial];return b},q=function(b){var c=a(this),d=c.siblings("ul");if(0<d.length&&!d.is(":visible")&&(c.data("follow",!1),"MSPointerDown"===b.type))return c.trigger("focus"),!1},z=function(b){var c=a(this),e=c.siblings("ul"),g=!1===c.data("follow")?!1:!0;
!e.length||!d.op.useClick&&g||(b.preventDefault(),e.is(":visible")?d.op.useClick&&g&&a.proxy(f,c.parent("li"),b)():a.proxy(k,c.parent("li"))())};return this.addClass(e.menuClass).each(function(){var p=this.serial=d.o.length,r=a.extend({},d.defaults,b),D=a(this),L=D.find("li:has(ul)");r.$path=D.find("li."+r.pathClass).slice(0,r.pathLevels).each(function(){a(this).addClass(r.hoverClass+" "+e.bcClass).filter("li:has(ul)").removeClass(r.pathClass)});d.o[p]=d.op=r;r.autoArrows&&L.children("a").each(function(){a(this).addClass(e.anchorClass).append(g.clone())});
D.css("ms-touch-action","none");if(!d.op.useClick)if(a.fn.hoverIntent&&!d.op.disableHI)D.hoverIntent(k,f,"li:has(ul)");else D.on("mouseenter","li:has(ul)",k).on("mouseleave","li:has(ul)",f);p="MSPointerDown";navigator.userAgent.toLowerCase().match(/(iphone|ipod|ipad)/)||(p+=" touchstart");D.on("focusin","li",k).on("focusout","li",f).on("click","a",z).on(p,"a",q);L.not("."+e.bcClass).children("ul").show().hide();r.onInit.call(this)})};var b=a.fn.superfish;b.o=[];b.op={};b.c={bcClass:"sf-breadcrumb",
...
(function(a){var b=0,c=0,d=0,e=0,g="ontouchstart"in window||0<navigator.msMaxTouchPoints,k="onorientationchange"in window,f=!1,p=!1,q=!1,z=!1,v=!1,r="pointer",D="pointer",L=[],N=[],la=[],U=[],I=[],aa=[],J=[],n=[],A=[],ba=[],ga=[],l={showScrollbar:function(b,c){b.scrollbarHide&&a("."+c).css({opacity:b.scrollbarOpacity,filter:"alpha(opacity:"+100*b.scrollbarOpacity+")"})},hideScrollbar:function(a,b,c,d,e,h,f,g,k,p){if(a.scrollbar&&a.scrollbarHide)for(var q=c;q<c+25;q++)b[b.length]=l.hideScrollbarIntervalTimer(10*
q,d[c],(c+24-q)/24,e,h,f,g,k,p,a)},hideScrollbarInterval:function(b,c,d,f,g,h,k,p,q){e=-1*b/A[p]*(g-h-k-f);l.setSliderOffset("."+d,e);a("."+d).css({opacity:q.scrollbarOpacity*c,filter:"alpha(opacity:"+q.scrollbarOpacity*c*100+")"})},slowScrollHorizontalInterval:function(b,c,d,f,g,h,k,p,q,D,M,r,z,Q,E,y,v,x,w){if(w.infiniteSlider){if(d<=-1*A[y]){var B=a(b).width();if(d<=-1*ba[y]){var C=-1*M[0];a(c).each(function(b){l.setSliderOffset(a(c)[b],C+v);b<r.length&&(r[b]=-1*C);C+=E[b]});d+=-1*r[0];n[y]=-1*
r[0]+v;A[y]=n[y]+B-h;J[y]=0}else{var t=0,P=l.getSliderOffset(a(c[0]),"x");a(c).each(function(a){l.getSliderOffset(this,"x")<P&&(P=l.getSliderOffset(this,"x"),t=a)});z=n[y]+B;l.setSliderOffset(a(c)[t],z);n[y]=-1*r[1]+v;A[y]=n[y]+B-h;r.splice(0,1);r.splice(r.length,0,-1*z+v);J[y]++}}if(d>=-1*n[y]||0<=d){B=a(b).width();if(0<d)for(C=-1*M[0],a(c).each(function(b){l.setSliderOffset(a(c)[b],C+v);b<r.length&&(r[b]=-1*C);C+=E[b]}),d-=-1*r[0],n[y]=-1*r[0]+v,A[y]=n[y]+B-h,J[y]=Q;0<-1*r[0]-B+v;){var K=0,L=l.getSliderOffset(a(c[0]),
"x");a(c).each(function(a){l.getSliderOffset(this,"x")>L&&(L=l.getSliderOffset(this,"x"),K=a)});z=n[y]-E[K];l.setSliderOffset(a(c)[K],z);r.splice(0,0,-1*z+v);r.splice(r.length-1,1);n[y]=-1*r[0]+v;A[y]=n[y]+B-h;J[y]--;I[y]++}0>d&&(K=0,L=l.getSliderOffset(a(c[0]),"x"),a(c).each(function(a){l.getSliderOffset(this,"x")>L&&(L=l.getSliderOffset(this,"x"),K=a)}),z=n[y]-E[K],l.setSliderOffset(a(c)[K],z),r.splice(0,0,-1*z+v),r.splice(r.length-1,1),n[y]=-1*r[0]+v,A[y]=n[y]+B-h,J[y]--)}}M=!1;h=l.calcActiveOffset(w,
d,r,h,J[y],Q,D,y);z=(h+J[y]+Q)%Q;w.infiniteSlider?z!=aa[y]&&(M=!0):h!=I[y]&&(M=!0);if(M&&(Q=new l.args("change",w,b,a(b).children(":eq("+z+")"),z,x),a(b).parent().data("args",Q),""!=w.onSlideChange))w.onSlideChange(Q);I[y]=h;aa[y]=z;d=Math.floor(d);l.setSliderOffset(b,d);w.scrollbar&&(e=Math.floor((-1*d-n[y]+v)/(A[y]-n[y]+v)*(k-p-g)),b=g-q,d>=-1*n[y]+v?(b=g-q- -1*e,l.setSliderOffset(a("."+f),0)):(d<=-1*A[y]+1&&(b=k-p-q-e),l.setSliderOffset(a("."+f),e)),a("."+f).css({width:b+"px"}))},slowScrollHorizontal:function(b,
c,d,e,f,h,g,k,p,q,r,z,D,Q,E,y,v,x,w,B,C){var t=l.getSliderOffset(b,"x");h=[];var P=0,K=25/1024*k;frictionCoefficient=C.frictionCoefficient;elasticFrictionCoefficient=C.elasticFrictionCoefficient;snapFrictionCoefficient=C.snapFrictionCoefficient;f>C.snapVelocityThreshold&&C.snapToChildren&&!w?P=1:f<-1*C.snapVelocityThreshold&&C.snapToChildren&&!w&&(P=-1);f<-1*K?f=-1*K:f>K&&(f=K);a(b)[0]!==a(x)[0]&&(P*=-1,f*=-2);x=J[E];if(C.infiniteSlider)var L=n[E],u=A[E];w=[];for(var K=[],H=0;H<D.length;H++)w[H]=
D[H],H<c.length&&(K[H]=l.getSliderOffset(a(c[H]),"x"));for(;1<f||-1>f;){f*=frictionCoefficient;t+=f;(t>-1*n[E]||t<-1*A[E])&&!C.infiniteSlider&&(f*=elasticFrictionCoefficient,t+=f);if(C.infiniteSlider){if(t<=-1*u){for(var u=a(b).width(),N=0,W=K[0],H=0;H<K.length;H++)K[H]<W&&(W=K[H],N=H);H=L+u;K[N]=H;L=-1*w[1]+B;u=L+u-k;w.splice(0,1);w.splice(w.length,0,-1*H+B);x++}if(t>=-1*L){u=a(b).width();N=0;W=K[0];for(H=0;H<K.length;H++)K[H]>W&&(W=K[H],N=H);H=L-Q[N];K[N]=H;w.splice(0,0,-1*H+B);w.splice(w.length-
1,1);L=-1*w[0]+B;u=L+u-k;x--}}h[h.length]=t}K=!1;f=l.calcActiveOffset(C,t,w,k,x,v,I[E],E);C.snapToChildren&&(C.infiniteSlider?(f+x+v)%v!=aa[E]&&(K=!0):f!=I[E]&&(K=!0),0>P&&!K?(f++,f>=D.length&&!C.infiniteSlider&&(f=D.length-1)):0<P&&!K&&(f--,0>f&&!C.infiniteSlider&&(f=0)));if(C.snapToChildren||(t>-1*n[E]||t<-1*A[E])&&!C.infiniteSlider){for((t>-1*n[E]||t<-1*A[E])&&!C.infiniteSlider?h.splice(0,h.length):(h.splice(.1*h.length,h.length),t=0<h.length?h[h.length-1]:t);t<w[f]-.5||t>w[f]+.5;)t=(t-w[f])*snapFrictionCoefficient+
w[f],h[h.length]=t;h[h.length]=w[f]}P=1;0!=h.length%2&&(P=0);for(t=0;t<d.length;t++)clearTimeout(d[t]);x=(f+x+v)%v;L=0;for(t=P;t<h.length;t+=2)if(t==P||1<Math.abs(h[t]-L)||t>=h.length-2)L=h[t],d[d.length]=l.slowScrollHorizontalIntervalTimer(10*t,b,c,h[t],e,g,k,p,q,r,f,z,D,y,v,Q,E,B,x,C);L=(f+J[E]+v)%v;""!=C.onSlideComplete&&1<h.length&&(d[d.length]=l.onSlideCompleteTimer(10*(t+1),C,b,a(b).children(":eq("+L+")"),x,E));U[E]=d;l.hideScrollbar(C,d,t,h,e,g,k,q,r,E)},onSlideComplete:function(b,c,d,e,f){d=
new l.args("complete",b,a(c),d,e,e);a(c).parent().data("args",d);if(""!=b.onSlideComplete)b.onSlideComplete(d)},getSliderOffset:function(b,c){var d=0;c="x"==c?4:5;if(!f||p||q)d=parseInt(a(b).css("left"),10);else{for(var d=["-webkit-transform","-moz-transform","transform"],e,g=0;g<d.length;g++)if(void 0!=a(b).css(d[g])&&0<a(b).css(d[g]).length){e=a(b).css(d[g]).split(",");break}d=void 0==e[c]?0:parseInt(e[c],10)}return d},setSliderOffset:function(b,c){c=parseInt(c,10);!f||p||q?a(b).css({left:c+"px"}):
a(b).css({msTransform:"matrix(1,0,0,1,"+c+",0)",webkitTransform:"matrix(1,0,0,1,"+c+",0)",MozTransform:"matrix(1,0,0,1,"+c+",0)",transform:"matrix(1,0,0,1,"+c+",0)"})},setBrowserInfo:function(){null!=navigator.userAgent.match("WebKit")?(r="-webkit-grab",D="-webkit-grabbing"):null!=navigator.userAgent.match("Gecko")?(v=!0,r="move",D="-moz-grabbing"):null!=navigator.userAgent.match("MSIE 7")?z=p=!0:null!=navigator.userAgent.match("MSIE 8")?z=q=!0:null!=navigator.userAgent.match("MSIE 9")&&(z=!0)},has3DTransform:function(){var b=
...
c[f-1]),a[a.length]=c[f],e=!0);0==a.length&&(a[0]=c[c.length-1]);for(f=e=0;f<a.length;f++)g=Math.abs(b-a[f]),g<d&&(e=a[f],d=g);for(f=0;f<c.length;f++)e==c[f]&&(p=f);return p},changeSlide:function(b,c,d,e,f,h,g,k,p,q,r,z,D,n,v,y,L,x){l.autoSlidePause(n);for(var w=0;w<e.length;w++)clearTimeout(e[w]);var B=Math.ceil(x.autoSlideTransTimer/10)+1,C=l.getSliderOffset(c,"x"),t=z[b],A=t-C;if(x.infiniteSlider)for(b=(b-J[n]+2*y)%y,w=!1,0==b&&2==y&&(b=y,z[b]=z[b-1]-a(d).eq(0).outerWidth(!0),w=!0),t=z[b],A=t-
C,t=[z[b]-a(c).width(),z[b]+a(c).width()],w&&z.splice(z.length-1,1),w=0;w<t.length;w++)Math.abs(t[w]-C)<Math.abs(A)&&(A=t[w]-C);var t=[],K;l.showScrollbar(x,f);for(w=0;w<=B;w++)K=w,K/=B,K--,K=C+A*(Math.pow(K,5)+1),t[t.length]=K;B=(b+J[n]+y)%y;for(w=C=0;w<t.length;w++){if(0==w||1<Math.abs(t[w]-C)||w>=t.length-2)C=t[w],e[w]=l.slowScrollHorizontalIntervalTimer(10*(w+1),c,d,t[w],f,h,g,k,p,q,b,r,z,v,y,D,n,L,B,x);0==w&&""!=x.onSlideStart&&(A=(I[n]+J[n]+y)%y,x.onSlideStart(new l.args("start",x,c,a(c).children(":eq("+
A+")"),A,b)))}C=!1;x.infiniteSlider?B!=aa[n]&&(C=!0):b!=I[n]&&(C=!0);C&&""!=x.onSlideComplete&&(e[e.length]=l.onSlideCompleteTimer(10*(w+1),x,c,a(c).children(":eq("+B+")"),B,n));U[n]=e;l.hideScrollbar(x,e,w,t,f,h,g,p,q,n);l.autoSlide(c,d,e,f,h,g,k,p,q,r,z,D,n,v,y,L,x)},autoSlide:function(a,b,c,d,e,f,g,k,p,q,r,z,n,D,v,y,A){if(!N[n].autoSlide)return!1;l.autoSlidePause(n);L[n]=setTimeout(function(){!A.infiniteSlider&&I[n]>r.length-1&&(I[n]-=v);l.changeSlide((I[n]+J[n]+r.length+1)%r.length,a,b,c,d,e,
f,g,k,p,q,r,z,n,D,v,y,A);l.autoSlide(a,b,c,d,e,f,g,k,p,q,r,z,n,D,v,y,A)},A.autoSlideTimer+A.autoSlideTransTimer)},autoSlidePause:function(a){clearTimeout(L[a])},isUnselectable:function(b,c){return""!=c.unselectableSelector&&1==a(b).closest(c.unselectableSelector).length?!0:!1},slowScrollHorizontalIntervalTimer:function(a,b,c,d,e,f,g,k,p,q,r,n,z,D,v,y,A,x,w,B){return setTimeout(function(){l.slowScrollHorizontalInterval(b,c,d,e,f,g,k,p,q,r,n,z,D,v,y,A,x,w,B)},a)},onSlideCompleteTimer:function(a,b,c,
d,e,f){return setTimeout(function(){l.onSlideComplete(b,c,d,e,f)},a)},hideScrollbarIntervalTimer:function(a,b,c,d,e,f,g,k,p,q){return setTimeout(function(){l.hideScrollbarInterval(b,c,d,e,f,g,k,p,q)},a)},args:function(b,c,d,e,f,g){this.prevSlideNumber=void 0==a(d).parent().data("args")?void 0:a(d).parent().data("args").prevSlideNumber;this.prevSlideObject=void 0==a(d).parent().data("args")?void 0:a(d).parent().data("args").prevSlideObject;this.targetSlideNumber=g+1;this.targetSlideObject=a(d).children(":eq("+
...
this.sliderObject=d;this.sliderContainerObject=a(d).parent();this.currentSlideObject=e;this.currentSlideNumber=f+1;this.currentSliderOffset=-1*l.getSliderOffset(d,"x")},preventDrag:function(a){a.preventDefault()},preventClick:function(a){a.stopImmediatePropagation();return!1},enableClick:function(){return!0}};l.setBrowserInfo();var X={init:function(R,v){f=l.has3DTransform();var m=a.extend(!0,{elasticPullResistance:.6,frictionCoefficient:.92,elasticFrictionCoefficient:.6,snapFrictionCoefficient:.92,
snapToChildren:!1,snapSlideCenter:!1,startAtSlide:1,scrollbar:!1,scrollbarDrag:!1,scrollbarHide:!0,scrollbarLocation:"top",scrollbarContainer:"",scrollbarOpacity:.4,scrollbarHeight:"4px",scrollbarBorder:"0",scrollbarMargin:"5px",scrollbarBackground:"#000",scrollbarBorderRadius:"100px",scrollbarShadow:"0 0 0 #000",scrollbarElasticPullResistance:.9,desktopClickDrag:!1,keyboardControls:!1,tabToAdvance:!1,responsiveSlideContainer:!0,responsiveSlides:!0,navSlideSelector:"",navPrevSelector:"",navNextSelector:"",
autoSlideToggleSelector:"",autoSlide:!1,autoSlideTimer:5E3,autoSlideTransTimer:750,autoSlideHoverPause:!0,infiniteSlider:!1,snapVelocityThreshold:5,slideStartVelocityThreshold:0,horizontalSlideLockThreshold:5,verticalSlideLockThreshold:3,stageCSS:{position:"relative",top:"0",left:"0",overflow:"hidden",zIndex:1},unselectableSelector:"",onSliderLoaded:"",onSliderUpdate:"",onSliderResize:"",onSlideStart:"",onSlideChange:"",onSlideComplete:""},R);void 0==v&&(v=this);return a(v).each(function(f){function ha(){l.autoSlidePause(h);
wa=a(F).find("a");Ca=a(F).find("[onclick]");qa=a(F).find("*");a(w).css("width","");a(w).css("height","");a(F).css("width","");G=a(F).children().not("script").get();ja=[];T=[];m.responsiveSlides&&a(G).css("width","");A[h]=0;u=[];y=a(w).parent().width();B=a(w).outerWidth(!0);m.responsiveSlideContainer&&(B=a(w).outerWidth(!0)>y?y:a(w).width());a(w).css({position:m.stageCSS.position,top:m.stageCSS.top,left:m.stageCSS.left,overflow:m.stageCSS.overflow,zIndex:m.stageCSS.zIndex,webkitPerspective:1E3,webkitBackfaceVisibility:"hidden",
msTouchAction:"pan-y",width:B});a(m.unselectableSelector).css({cursor:"default"});for(var b=0;b<G.length;b++){ja[b]=a(G[b]).width();T[b]=a(G[b]).outerWidth(!0);var c=T[b];m.responsiveSlides&&(T[b]>B?(c=B+-1*(T[b]-ja[b]),ja[b]=c,T[b]=B):c=ja[b],a(G[b]).css({width:c}));a(G[b]).css({webkitBackfaceVisibility:"hidden",overflow:"hidden",position:"absolute"});u[b]=-1*A[h];A[h]=A[h]+c+(T[b]-ja[b])}m.snapSlideCenter&&(x=.5*(B-T[0]),m.responsiveSlides&&T[0]>B&&(x=0));ba[h]=2*A[h];for(b=0;b<G.length;b++)l.setSliderOffset(a(G[b]),
-1*u[b]+A[h]+x),u[b]-=A[h];if(!m.infiniteSlider&&!m.snapSlideCenter){for(b=0;b<u.length&&!(u[b]<=-1*(2*A[h]-B));b++)Da=b;u.splice(Da+1,u.length);u[u.length]=-1*(2*A[h]-B)}for(b=0;b<u.length;b++)H[b]=u[b];ua&&(N[h].startAtSlide=N[h].startAtSlide>u.length?u.length:N[h].startAtSlide,m.infiniteSlider?(N[h].startAtSlide=(N[h].startAtSlide-1+O)%O,I[h]=N[h].startAtSlide):(N[h].startAtSlide=0>N[h].startAtSlide-1?u.length-1:N[h].startAtSlide,I[h]=N[h].startAtSlide-1),aa[h]=I[h]);n[h]=A[h]+x;a(F).css({position:"relative",
cursor:r,webkitPerspective:"0",webkitBackfaceVisibility:"hidden",width:A[h]+"px"});da=A[h];A[h]=2*A[h]-B+2*x;(ea=da+x<B||0==B?!0:!1)&&a(F).css({cursor:"default"});X=a(w).parent().outerHeight(!0);C=a(w).height();m.responsiveSlideContainer&&(C=C>X?X:C);a(w).css({height:C});l.setSliderOffset(F,u[I[h]]);if(m.infiniteSlider&&!ea){b=l.getSliderOffset(a(F),"x");for(c=(J[h]+O)%O*-1;0>c;){var d=0,e=l.getSliderOffset(a(G[0]),"x");a(G).each(function(a){l.getSliderOffset(this,"x")<e&&(e=l.getSliderOffset(this,
"x"),d=a)});var f=n[h]+da;l.setSliderOffset(a(G)[d],f);n[h]=-1*u[1]+x;A[h]=n[h]+da-B;u.splice(0,1);u.splice(u.length,0,-1*f+x);c++}for(;0<-1*u[0]-da+x&&m.snapSlideCenter&&ua;){var g=0,S=l.getSliderOffset(a(G[0]),"x");a(G).each(function(a){l.getSliderOffset(this,"x")>S&&(S=l.getSliderOffset(this,"x"),g=a)});f=n[h]-T[g];l.setSliderOffset(a(G)[g],f);u.splice(0,0,-1*f+x);u.splice(u.length-1,1);n[h]=-1*u[0]+x;A[h]=n[h]+da-B;J[h]--;I[h]++}for(;b<=-1*A[h];)d=0,e=l.getSliderOffset(a(G[0]),"x"),a(G).each(function(a){l.getSliderOffset(this,
"x")<e&&(e=l.getSliderOffset(this,"x"),d=a)}),f=n[h]+da,l.setSliderOffset(a(G)[d],f),n[h]=-1*u[1]+x,A[h]=n[h]+da-B,u.splice(0,1),u.splice(u.length,0,-1*f+x),J[h]++,I[h]--}l.setSliderOffset(F,u[I[h]]);m.desktopClickDrag||a(F).css({cursor:"default"});m.scrollbar&&(a("."+V).css({margin:m.scrollbarMargin,overflow:"hidden",display:"none"}),a("."+V+" ."+M).css({border:m.scrollbarBorder}),t=parseInt(a("."+V).css("marginLeft"))+parseInt(a("."+V).css("marginRight")),P=parseInt(a("."+V+" ."+M).css("borderLeftWidth"),
10)+parseInt(a("."+V+" ."+M).css("borderRightWidth"),10),Q=""!=m.scrollbarContainer?a(m.scrollbarContainer).width():B,E=B/da*(Q-t),m.scrollbarHide||(va=m.scrollbarOpacity),a("."+V).css({position:"absolute",left:0,width:Q-t+"px",margin:m.scrollbarMargin}),"top"==m.scrollbarLocation?a("."+V).css("top","0"):a("."+V).css("bottom","0"),a("."+V+" ."+M).css({borderRadius:m.scrollbarBorderRadius,background:m.scrollbarBackground,height:m.scrollbarHeight,width:E-P+"px",minWidth:m.scrollbarHeight,border:m.scrollbarBorder,
webkitPerspective:1E3,webkitBackfaceVisibility:"hidden",position:"relative",opacity:va,filter:"alpha(opacity:"+100*va+")",boxShadow:m.scrollbarShadow}),l.setSliderOffset(a("."+V+" ."+M),Math.floor((-1*u[I[h]]-n[h]+x)/(A[h]-n[h]+x)*(Q-t-E))),a("."+V).css({display:"block"}),Y=a("."+V+" ."+M),Ba=a("."+V));m.scrollbarDrag&&!ea&&a("."+V+" ."+M).css({cursor:r});m.infiniteSlider&&(Z=(A[h]+B)/3);""!=m.navSlideSelector&&a(m.navSlideSelector).each(function(b){a(this).css({cursor:"pointer"});a(this).unbind(ca).bind(ca,
function(c){"touchstart"==c.type?a(this).unbind("click.iosSliderEvent"):a(this).unbind("touchstart.iosSliderEvent");ca=c.type+".iosSliderEvent";l.changeSlide(b,F,G,R,M,E,B,Q,t,P,H,u,T,h,Z,O,x,m)})});""!=m.navPrevSelector&&(a(m.navPrevSelector).css({cursor:"pointer"}),a(m.navPrevSelector).unbind(ca).bind(ca,function(b){"touchstart"==b.type?a(this).unbind("click.iosSliderEvent"):a(this).unbind("touchstart.iosSliderEvent");ca=b.type+".iosSliderEvent";b=(I[h]+J[h]+O)%O;(0<b||m.infiniteSlider)&&l.changeSlide(b-
1,F,G,R,M,E,B,Q,t,P,H,u,T,h,Z,O,x,m)}));""!=m.navNextSelector&&(a(m.navNextSelector).css({cursor:"pointer"}),a(m.navNextSelector).unbind(ca).bind(ca,function(b){"touchstart"==b.type?a(this).unbind("click.iosSliderEvent"):a(this).unbind("touchstart.iosSliderEvent");ca=b.type+".iosSliderEvent";b=(I[h]+J[h]+O)%O;(b<u.length-1||m.infiniteSlider)&&l.changeSlide(b+1,F,G,R,M,E,B,Q,t,P,H,u,T,h,Z,O,x,m)}));m.autoSlide&&!ea&&""!=m.autoSlideToggleSelector&&(a(m.autoSlideToggleSelector).css({cursor:"pointer"}),
a(m.autoSlideToggleSelector).unbind(ca).bind(ca,function(b){"touchstart"==b.type?a(this).unbind("click.iosSliderEvent"):a(this).unbind("touchstart.iosSliderEvent");ca=b.type+".iosSliderEvent";ma?(l.autoSlide(F,G,R,M,E,B,Q,t,P,H,u,T,h,Z,O,x,m),ma=!1,a(m.autoSlideToggleSelector).removeClass("on")):(l.autoSlidePause(h),ma=!0,a(m.autoSlideToggleSelector).addClass("on"))}));l.autoSlide(F,G,R,M,E,B,Q,t,P,H,u,T,h,Z,O,x,m);a(w).bind("mouseleave.iosSliderEvent",function(){if(ma)return!0;l.autoSlide(F,G,R,
M,E,B,Q,t,P,H,u,T,h,Z,O,x,m)});a(w).bind("touchend.iosSliderEvent",function(){if(ma)return!0;l.autoSlide(F,G,R,M,E,B,Q,t,P,H,u,T,h,Z,O,x,m)});m.autoSlideHoverPause&&a(w).bind("mouseenter.iosSliderEvent",function(){l.autoSlidePause(h)});a(w).data("iosslider",{obj:Ea,settings:m,scrollerNode:F,slideNodes:G,numberOfSlides:O,centeredSlideOffset:x,sliderNumber:h,originalOffsets:H,childrenOffsets:u,sliderMax:A[h],scrollbarClass:M,scrollbarWidth:E,scrollbarStageWidth:Q,stageWidth:B,scrollMargin:t,scrollBorder:P,
infiniteSliderOffset:J[h],infiniteSliderWidth:Z,slideNodeOuterWidths:T,shortContent:ea});ua=!1;return!0}b++;var h=b,R=[];N[h]=a.extend({},m);n[h]=0;A[h]=0;var v=[0,0],L=[0,0],V="scrollbarBlock"+b,M="scrollbar"+b,Y,Ba,Q,E,y,X,x=0,w=a(this),B,C,t,P,K,ua=!0;f=-1;var u,H=[],va=0,W=0,Fa=0,F=a(this).children(":first-child"),G,ja,T,O=a(F).children().not("script").length,fa=!1,Da=0,xa=!1,ra=void 0,Z;J[h]=0;var ea=!1,ma=!1;la[h]=!1;var ia,sa=!1,na=!1,ca="touchstart.iosSliderEvent click.iosSliderEvent",da,
wa,Ca,qa;ga[h]=!1;U[h]=[];m.scrollbarDrag&&(m.scrollbar=!0,m.scrollbarHide=!1);var Ea=a(this);if(void 0!=Ea.data("iosslider"))return!0;var oa=[],pa=Math.floor(12317*Math.random());a(F).parent().append("<i class = 'i"+pa+"'></i>").append("<i class = 'i"+pa+"'></i>");a(".i"+pa).css({position:"absolute",right:"10px",bottom:"10px",zIndex:1E3,fontStyle:"normal",background:"#fff",opacity:.2}).eq(1).css({bottom:"auto",right:"auto",top:"10px",left:"10px"});for(f=0;f<oa.length;f++)a(".i"+pa).html(a(".i"+pa).html()+
oa[f]);14.2<=parseInt(a().jquery.split(".").join(""),10)?a(this).delegate("img","dragstart.iosSliderEvent",function(a){a.preventDefault()}):a(this).find("img").bind("dragstart.iosSliderEvent",function(a){a.preventDefault()});m.infiniteSlider&&(m.scrollbar=!1);m.infiniteSlider&&1==O&&(m.infiniteSlider=!1);m.scrollbar&&(""!=m.scrollbarContainer?a(m.scrollbarContainer).append("<div class = '"+V+"'><div class = '"+M+"'></div></div>"):a(F).parent().append("<div class = '"+V+"'><div class = '"+M+"'></div></div>"));
if(!ha())return!0;a(this).find("a").bind("mousedown",l.preventDrag);a(this).find("[onclick]").bind("click",l.preventDrag).each(function(){a(this).data("onclick",this.onclick)});f=l.calcActiveOffset(m,l.getSliderOffset(a(F),"x"),u,B,J[h],O,void 0,h);f=(f+J[h]+O)%O;f=new l.args("load",m,F,a(F).children(":eq("+f+")"),f,f);a(w).data("args",f);if(""!=m.onSliderLoaded)m.onSliderLoaded(f);if(N[h].responsiveSlides||N[h].responsiveSlideContainer)f=k?"orientationchange":"resize",a(window).bind(f+".iosSliderEvent-"+
h,function(){if(!ha())return!0;var b=a(w).data("args");if(""!=m.onSliderResize)m.onSliderResize(b)});!m.keyboardControls&&!m.tabToAdvance||ea||a(document).bind("keydown.iosSliderEvent",function(a){p||q||(a=a.originalEvent);if(ga[h])return!0;if(37==a.keyCode&&m.keyboardControls)a.preventDefault(),a=(I[h]+J[h]+O)%O,(0<a||m.infiniteSlider)&&l.changeSlide(a-1,F,G,R,M,E,B,Q,t,P,H,u,T,h,Z,O,x,m);else if(39==a.keyCode&&m.keyboardControls||9==a.keyCode&&m.tabToAdvance)a.preventDefault(),a=(I[h]+J[h]+O)%O,
(a<u.length-1||m.infiniteSlider)&&l.changeSlide(a+1,F,G,R,M,E,B,Q,t,P,H,u,T,h,Z,O,x,m)});if(g||m.desktopClickDrag){var ka=!1,ya=!1;f=a(F);var ta=a(F),za=!1;m.scrollbarDrag&&(f=f.add(Y),ta=ta.add(Ba));a(f).bind("mousedown.iosSliderEvent touchstart.iosSliderEvent",function(b){if(ka)return!0;ka=!0;ya=!1;"touchstart"==b.type?a(ta).unbind("mousedown.iosSliderEvent"):a(ta).unbind("touchstart.iosSliderEvent");if(ga[h]||ea||(za=l.isUnselectable(b.target,m)))return fa=ka=!1,!0;ia=a(this)[0]===a(Y)[0]?Y:F;
p||q||(b=b.originalEvent);l.autoSlidePause(h);qa.unbind(".disableClick");if("touchstart"==b.type)eventX=b.touches[0].pageX,eventY=b.touches[0].pageY;else{if(window.getSelection)window.getSelection().empty?window.getSelection().empty():window.getSelection().removeAllRanges&&window.getSelection().removeAllRanges();else if(document.selection)if(q)try{document.selection.empty()}catch(d){}else document.selection.empty();eventX=b.pageX;eventY=b.pageY;xa=!0;ra=F;a(this).css({cursor:D})}v=[0,0];L=[0,0];c=
0;fa=!1;for(b=0;b<R.length;b++)clearTimeout(R[b]);b=l.getSliderOffset(F,"x");b>-1*n[h]+x+da?(b=-1*n[h]+x+da,l.setSliderOffset(a("."+M),b),a("."+M).css({width:E-P+"px"})):b<-1*A[h]&&(l.setSliderOffset(a("."+M),Q-t-E),a("."+M).css({width:E-P+"px"}));b=a(this)[0]===a(Y)[0]?n[h]:0;W=-1*(l.getSliderOffset(this,"x")-eventX-b);l.getSliderOffset(this,"y");v[1]=eventX;L[1]=eventY;na=!1});a(document).bind("touchmove.iosSliderEvent mousemove.iosSliderEvent",function(b){p||q||(b=b.originalEvent);if(ga[h]||ea||
za||!ka)return!0;var f=0;if("touchmove"==b.type)eventX=b.touches[0].pageX,eventY=b.touches[0].pageY;else{if(window.getSelection)window.getSelection().empty||window.getSelection().removeAllRanges&&window.getSelection().removeAllRanges();else if(document.selection)if(q)try{document.selection.empty()}catch(g){}else document.selection.empty();eventX=b.pageX;eventY=b.pageY;if(!xa||!z&&("undefined"!=typeof b.webkitMovementX||"undefined"!=typeof b.webkitMovementY)&&0===b.webkitMovementY&&0===b.webkitMovementX)return!0}v[0]=
v[1];v[1]=eventX;c=(v[1]-v[0])/2;L[0]=L[1];L[1]=eventY;d=(L[1]-L[0])/2;if(!fa){var S=(I[h]+J[h]+O)%O,S=new l.args("start",m,F,a(F).children(":eq("+S+")"),S,void 0);a(w).data("args",S);if(""!=m.onSlideStart)m.onSlideStart(S)}(d>m.verticalSlideLockThreshold||d<-1*m.verticalSlideLockThreshold)&&"touchmove"==b.type&&!fa&&(sa=!0);(c>m.horizontalSlideLockThreshold||c<-1*m.horizontalSlideLockThreshold)&&"touchmove"==b.type&&b.preventDefault();if(c>m.slideStartVelocityThreshold||c<-1*m.slideStartVelocityThreshold)fa=
!0;if(fa&&!sa){var S=l.getSliderOffset(F,"x"),k=a(ia)[0]===a(Y)[0]?n[h]:x,ha=a(ia)[0]===a(Y)[0]?(n[h]-A[h]-x)/(Q-t-E):1,R=a(ia)[0]===a(Y)[0]?m.scrollbarElasticPullResistance:m.elasticPullResistance,r=m.snapSlideCenter&&a(ia)[0]===a(Y)[0]?0:x,D=m.snapSlideCenter&&a(ia)[0]===a(Y)[0]?x:0;"touchmove"==b.type&&(Fa!=b.touches.length&&(W=-1*S+eventX),Fa=b.touches.length);if(m.infiniteSlider){if(S<=-1*A[h]){var y=a(F).width();if(S<=-1*ba[h]){var C=-1*H[0];a(G).each(function(b){l.setSliderOffset(a(G)[b],C+
x);b<u.length&&(u[b]=-1*C);C+=T[b]});W-=-1*u[0];n[h]=-1*u[0]+x;A[h]=n[h]+y-B;J[h]=0}else{var Aa=0,V=l.getSliderOffset(a(G[0]),"x");a(G).each(function(a){l.getSliderOffset(this,"x")<V&&(V=l.getSliderOffset(this,"x"),Aa=a)});R=n[h]+y;l.setSliderOffset(a(G)[Aa],R);n[h]=-1*u[1]+x;A[h]=n[h]+y-B;u.splice(0,1);u.splice(u.length,0,-1*R+x);J[h]++}}if(S>=-1*n[h]||0<=S)if(y=a(F).width(),0<=S)for(C=-1*H[0],a(G).each(function(b){l.setSliderOffset(a(G)[b],C+x);b<u.length&&(u[b]=-1*C);C+=T[b]}),W+=-1*u[0],n[h]=
-1*u[0]+x,A[h]=n[h]+y-B,J[h]=O;0<-1*u[0]-y+x;){var N=0,U=l.getSliderOffset(a(G[0]),"x");a(G).each(function(a){l.getSliderOffset(this,"x")>U&&(U=l.getSliderOffset(this,"x"),N=a)});R=n[h]-T[N];l.setSliderOffset(a(G)[N],R);u.splice(0,0,-1*R+x);u.splice(u.length-1,1);n[h]=-1*u[0]+x;A[h]=n[h]+y-B;J[h]--;I[h]++}else N=0,U=l.getSliderOffset(a(G[0]),"x"),a(G).each(function(a){l.getSliderOffset(this,"x")>U&&(U=l.getSliderOffset(this,"x"),N=a)}),R=n[h]-T[N],l.setSliderOffset(a(G)[N],R),u.splice(0,0,-1*R+x),
u.splice(u.length-1,1),n[h]=-1*u[0]+x,A[h]=n[h]+y-B,J[h]--}else y=a(F).width(),S>-1*n[h]+x&&(f=(n[h]+-1*(W-k-eventX+r)*ha-k)*R*-1/ha),S<-1*A[h]&&(f=(A[h]+D+-1*(W-k-eventX)*ha-k)*R*-1/ha);l.setSliderOffset(F,-1*(W-k-eventX-f)*ha-k+D);m.scrollbar&&(l.showScrollbar(m,M),e=Math.floor((W-eventX-f-n[h]+r)/(A[h]-n[h]+x)*(Q-t-E)*ha),S=E,0>=e?(S=E-P- -1*e,l.setSliderOffset(a("."+M),0),a("."+M).css({width:S+"px"})):e>=Q-t-P-E?(S=Q-t-P-e,l.setSliderOffset(a("."+M),e),a("."+M).css({width:S+"px"})):l.setSliderOffset(a("."+
M),e));"touchmove"==b.type&&(K=b.touches[0].pageX);b=!1;f=l.calcActiveOffset(m,-1*(W-eventX-f),u,B,J[h],O,void 0,h);S=(f+J[h]+O)%O;m.infiniteSlider?S!=aa[h]&&(b=!0):f!=I[h]&&(b=!0);if(b&&(I[h]=f,aa[h]=S,na=!0,S=new l.args("change",m,F,a(F).children(":eq("+S+")"),S,S),a(w).data("args",S),""!=m.onSlideChange))m.onSlideChange(S)}});oa=a(window);if(q||p)oa=a(document);a(f).bind("touchcancel.iosSliderEvent touchend.iosSliderEvent",function(a){a=a.originalEvent;if(ya)return!1;ya=!0;if(ga[h]||ea||za)return!0;
if(0!=a.touches.length)for(var b=0;b<a.touches.length;b++)a.touches[b].pageX==K&&l.slowScrollHorizontal(F,G,R,M,c,d,E,B,Q,t,P,H,u,T,h,Z,O,ia,na,x,m);else l.slowScrollHorizontal(F,G,R,M,c,d,E,B,Q,t,P,H,u,T,h,Z,O,ia,na,x,m);ka=sa=!1;return!0});a(oa).bind("mouseup.iosSliderEvent-"+h,function(b){fa?wa.unbind("click.disableClick").bind("click.disableClick",l.preventClick):wa.unbind("click.disableClick").bind("click.disableClick",l.enableClick);Ca.each(function(){this.onclick=function(b){if(fa)return!1;
...
b.click[0].namespace){if(!fa)return!1;a(this).one("click.disableClick",l.preventClick);var b=a(this).data("events").click,c=b.pop();b.splice(0,0,c)}});if(!la[h]){if(ea)return!0;m.desktopClickDrag&&a(F).css({cursor:r});m.scrollbarDrag&&a(Y).css({cursor:r});xa=!1;if(void 0==ra)return!0;l.slowScrollHorizontal(ra,G,R,M,c,d,E,B,Q,t,P,H,u,T,h,Z,O,ia,na,x,m);ra=void 0}ka=sa=!1})}})},destroy:function(b,c){void 0==c&&(c=this);return a(c).each(function(){var c=a(this),d=c.data("iosslider");if(void 0==d)return!1;
...
a(this),c=b.data("iosslider");if(void 0==c)return!1;c.settings.startAtSlide=b.data("args").currentSlideNumber;X.destroy(!1,this);1!=c.numberOfSlides&&c.settings.infiniteSlider&&(c.settings.startAtSlide=(I[c.sliderNumber]+1+J[c.sliderNumber]+c.numberOfSlides)%c.numberOfSlides);X.init(c.settings,this);b=new l.args("update",c.settings,c.scrollerNode,a(c.scrollerNode).children(":eq("+(c.settings.startAtSlide-1)+")"),c.settings.startAtSlide-1,c.settings.startAtSlide-1);a(c.stageNode).data("args",b);if(""!=
...
(function(a){var b,c,d,e,g,k,f,p=function(){},q=!!window.jQuery,z=a(window),v=function(a,c){b.ev.on("mfp"+a+".mfp",c)},r=function(b,c,d,e){var f=document.createElement("div");return f.className="mfp-"+b,d&&(f.innerHTML=d),e?c&&c.appendChild(f):(f=a(f),c&&f.appendTo(c)),f},D=function(c,d){b.ev.triggerHandler("mfp"+c,d);b.st.callbacks&&(c=c.charAt(0).toLowerCase()+c.slice(1),b.st.callbacks[c]&&b.st.callbacks[c].apply(b,a.isArray(d)?d:[d]))},L=function(c){return c===f&&b.currTemplate.closeBtn||(b.currTemplate.closeBtn=
a(b.st.closeMarkup.replace("%title%",b.st.tClose)),f=c),b.currTemplate.closeBtn},N=function(){a.magnificPopup.instance||(b=new p,b.init(),a.magnificPopup.instance=b)},la=function(){var a=document.createElement("p").style,b=["ms","O","Moz","Webkit"];if(void 0!==a.transition)return!0;for(;b.length;)if(b.pop()+"Transition"in a)return!0;return!1};p.prototype={constructor:p,init:function(){var c=navigator.appVersion;b.isIE7=-1!==c.indexOf("MSIE 7.");b.isIE8=-1!==c.indexOf("MSIE 8.");b.isLowIE=b.isIE7||
...
b.bgOverlay||(b.bgOverlay=r("bg").on("click.mfp",function(){b.close()}),b.wrap=r("wrap").attr("tabindex",-1).on("click.mfp",function(a){b._checkIfClose(a.target)&&b.close()}),b.container=r("container",b.wrap));b.contentContainer=r("content");b.st.preloader&&(b.preloader=r("preloader",b.container,b.st.tLoading));g=a.magnificPopup.modules;for(f=0;g.length>f;f++)h=g[f],h=h.charAt(0).toUpperCase()+h.slice(1),b["init"+h].call(b);D("BeforeOpen");b.st.showCloseBtn&&(b.st.closeBtnInside?(v("MarkupParse",
function(a,b,c,d){c.close_replaceWith=L(d.type)}),k+=" mfp-close-btn-in"):b.wrap.append(L()));b.st.alignTop&&(k+=" mfp-align-top");b.fixedContentPos?b.wrap.css({overflow:b.st.overflowY,overflowX:"hidden",overflowY:b.st.overflowY}):b.wrap.css({top:z.scrollTop(),position:"absolute"});(!1===b.st.fixedBgPos||"auto"===b.st.fixedBgPos&&!b.fixedContentPos)&&b.bgOverlay.css({height:e.height(),position:"absolute"});b.st.enableEscapeKey&&e.on("keyup.mfp",function(a){27===a.keyCode&&b.close()});z.on("resize.mfp",
...
[b.currItem?b.currItem.type:"",d]),b.currItem=c,!b.currTemplate[d]){var e=b.st[d]?b.st[d].markup:!1;D("FirstMarkupParse",e);b.currTemplate[d]=e?a(e):!0}g&&g!==c.type&&b.container.removeClass("mfp-"+g+"-holder");e=b["get"+d.charAt(0).toUpperCase()+d.slice(1)](c,b.currTemplate[d]);b.appendContent(e,d);c.preloaded=!0;D("Change",c);g=c.type;b.container.prepend(b.contentContainer);D("AfterChange")},appendContent:function(a,c){(b.content=a)?b.st.showCloseBtn&&b.st.closeBtnInside&&!0===b.currTemplate[c]?
...
document.body.removeChild(a)}return b.scrollbarSize}};a.magnificPopup={instance:null,proto:p.prototype,modules:[],open:function(b,c){return N(),b=b?a.extend(!0,{},b):{},b.isObj=!0,b.index=c||0,this.instance.open(b)},close:function(){return a.magnificPopup.instance&&a.magnificPopup.instance.close()},registerModule:function(b,c){c.options&&(a.magnificPopup.defaults[b]=c.options);a.extend(this.proto,c.proto);this.modules.push(b)},defaults:{disableOn:0,key:null,midClick:!1,mainClass:"",preloader:!0,focus:"",
closeOnContentClick:!1,closeOnBgClick:!0,closeBtnInside:!0,showCloseBtn:!0,enableEscapeKey:!0,modal:!1,alignTop:!1,removalDelay:0,prependTo:null,fixedContentPos:"auto",fixedBgPos:"auto",overflowY:"auto",closeMarkup:'<button title="%title%" type="button" class="mfp-close">&times;</button>',tClose:"Close (Esc)",tLoading:"Loading..."}};a.fn.magnificPopup=function(c){N();var d=a(this);if("string"==typeof c)if("open"===c){var e,f=q?d.data("magnificPopup"):d[0].magnificPopup,g=parseInt(arguments[1],10)||
0;f.items?e=f.items[g]:(e=d,f.delegate&&(e=e.find(f.delegate)),e=e.eq(g));b._openClick({mfpEl:e},d,f)}else b.isOpen&&b[c].apply(b,Array.prototype.slice.call(arguments,1));else c=a.extend(!0,{},c),q?d.data("magnificPopup",c):d[0].magnificPopup=c,b.addGroup(d,c);return d};var U,I,aa,J=function(){aa&&(I.after(aa.addClass(U)).detach(),aa=null)};a.magnificPopup.registerModule("inline",{options:{hiddenClass:"hide",markup:"",tNotFound:"Content not found"},proto:{initInline:function(){b.types.push("inline");
v("Close.inline",function(){J()})},getInline:function(c,d){if(J(),c.src){var e=b.st.inline,f=a(c.src);if(f.length){var g=f[0].parentNode;g&&g.tagName&&(I||(U=e.hiddenClass,I=r(U),U="mfp-"+U),aa=f.after(I).detach().removeClass(U));b.updateStatus("ready")}else b.updateStatus("error",e.tNotFound),f=a("<div>");return c.inlineElement=f,f}return b.updateStatus("ready"),b._parseMarkup(d,{},c),d}}});var n,A=function(){n&&d.removeClass(n);b.req&&b.req.abort()};a.magnificPopup.registerModule("ajax",{options:{settings:null,
cursor:"mfp-ajax-cur",tError:'<a href="%url%">The content</a> could not be loaded.'},proto:{initAjax:function(){b.types.push("ajax");n=b.st.ajax.cursor;v("Close.ajax",A);v("BeforeChange.ajax",A)},getAjax:function(c){n&&d.addClass(n);b.updateStatus("loading");var e=a.extend({url:c.src,success:function(e,f,g){e={data:e,xhr:g};D("ParseAjax",e);b.appendContent(a(e.data),"ajax");c.finished=!0;n&&d.removeClass(n);b._setFocus();setTimeout(function(){b.wrap.addClass("mfp-ready")},16);b.updateStatus("ready");
D("AjaxContentAdded")},error:function(){n&&d.removeClass(n);c.finished=c.loadError=!0;b.updateStatus("error",b.st.ajax.tError.replace("%url%",c.src))}},b.st.ajax.settings);return b.req=a.ajax(e),""}}});var ba,ga=function(c){if(c.data&&void 0!==c.data.title)return c.data.title;var d=b.st.image.titleSrc;if(d){if(a.isFunction(d))return d.call(b,c);if(c.el)return c.el.attr(d)||""}return""};a.magnificPopup.registerModule("image",{options:{markup:'<div class="mfp-figure"><div class="mfp-close"></div><figure><div class="mfp-img"></div><figcaption><div class="mfp-bottom-bar"><div class="mfp-title"></div><div class="mfp-counter"></div></div></figcaption></figure></div>',
cursor:"mfp-zoom-out-cur",titleSrc:"title",verticalFit:!0,tError:'<a href="%url%">The image</a> could not be loaded.'},proto:{initImage:function(){var a=b.st.image;b.types.push("image");v("Open.image",function(){"image"===b.currItem.type&&a.cursor&&d.addClass(a.cursor)});v("Close.image",function(){a.cursor&&d.removeClass(a.cursor);z.off("resize.mfp")});v("Resize.image",b.resizeImage);b.isLowIE&&v("AfterChange",b.resizeImage)},resizeImage:function(){var a=b.currItem;if(a&&a.img&&b.st.image.verticalFit){var c=
...
gmaps:{index:"//maps.google.",src:"%id%&output=embed"}}},proto:{initIframe:function(){b.types.push("iframe");v("BeforeChange",function(a,b,c){b!==c&&("iframe"===b?X():"iframe"===c&&X(!0))});v("Close.iframe",function(){X()})},getIframe:function(c,d){var e=c.src,f=b.st.iframe;a.each(f.patterns,function(){return-1<e.indexOf(this.index)?(this.id&&(e="string"==typeof this.id?e.substr(e.lastIndexOf(this.id)+this.id.length,e.length):this.id.call(this,e)),e=this.src.replace("%id%",e),!1):void 0});var g={};
return f.srcAction&&(g[f.srcAction]=e),b._parseMarkup(d,g,c),b.updateStatus("ready"),d}}});var R=function(a){var c=b.items.length;return a>c-1?a-c:0>a?c+a:a},Y=function(a,b,c){return a.replace(/%curr%/gi,b+1).replace(/%total%/gi,c)};a.magnificPopup.registerModule("gallery",{options:{enabled:!1,arrowMarkup:'<button title="%title%" type="button" class="mfp-arrow mfp-arrow-%dir%"></button>',preload:[0,2],navigateByImgClick:!0,arrows:!0,tPrev:"Previous (Left arrow key)",tNext:"Next (Right arrow key)",
tCounter:"%curr% of %total%"},proto:{initGallery:function(){var c=b.st.gallery,d=!!a.fn.mfpFastClick;return b.direction=!0,c&&c.enabled?(k+=" mfp-gallery",v("Open.mfp-gallery",function(){c.navigateByImgClick&&b.wrap.on("click.mfp-gallery",".mfp-img",function(){return 1<b.items.length?(b.next(),!1):void 0});e.on("keydown.mfp-gallery",function(a){37===a.keyCode?b.prev():39===a.keyCode&&b.next()})}),v("UpdateStatus.mfp-gallery",function(a,c){c.text&&(c.text=Y(c.text,b.currItem.index,b.items.length))}),
v("MarkupParse.mfp-gallery",function(a,d,e,f){a=b.items.length;e.counter=1<a?Y(c.tCounter,f.index,a):""}),v("BuildControls.mfp-gallery",function(){if(1<b.items.length&&c.arrows&&!b.arrowLeft){var e=c.arrowMarkup,f=b.arrowLeft=a(e.replace(/%title%/gi,c.tPrev).replace(/%dir%/gi,"left")).addClass("mfp-prevent-close"),e=b.arrowRight=a(e.replace(/%title%/gi,c.tNext).replace(/%dir%/gi,"right")).addClass("mfp-prevent-close"),g=d?"mfpFastClick":"click";f[g](function(){b.prev()});e[g](function(){b.next()});
b.isIE7&&(r("b",f[0],!1,!0),r("a",f[0],!1,!0),r("b",e[0],!1,!0),r("a",e[0],!1,!0));b.container.append(f.add(e))}}),v("Change.mfp-gallery",function(){b._preloadTimeout&&clearTimeout(b._preloadTimeout);b._preloadTimeout=setTimeout(function(){b.preloadNearbyImages();b._preloadTimeout=null},16)}),v("Close.mfp-gallery",function(){e.off(".mfp-gallery");b.wrap.off("click.mfp-gallery");b.arrowLeft&&d&&b.arrowLeft.add(b.arrowRight).destroyMfpFastClick();b.arrowRight=b.arrowLeft=null}),void 0):!1},next:function(){b.direction=
...
c():c;1<c&&(v("ImageHasSize.retina",function(a,b){b.img.css({"max-width":b.img[0].naturalWidth/c,width:"100%"})}),v("ElementParse.retina",function(b,d){d.src=a.replaceSrc(d,c)}))}}}});(function(){var b="ontouchstart"in window,c=function(){z.off("touchmove"+d+" touchend"+d)},d=".mfpFastClick";a.fn.mfpFastClick=function(e){return a(this).each(function(){var f,g=a(this);if(b){var k,p,q,l,r,n;g.on("touchstart"+d,function(a){l=!1;n=1;r=a.originalEvent?a.originalEvent.touches[0]:a.touches[0];p=r.clientX;
q=r.clientY;z.on("touchmove"+d,function(a){r=a.originalEvent?a.originalEvent.touches:a.touches;n=r.length;r=r[0];(10<Math.abs(r.clientX-p)||10<Math.abs(r.clientY-q))&&(l=!0,c())}).on("touchend"+d,function(a){c();l||1<n||(f=!0,a.preventDefault(),clearTimeout(k),k=setTimeout(function(){f=!1},1E3),e())})})}g.on("click"+d,function(){f||e()})})};a.fn.destroyMfpFastClick=function(){a(this).off("touchstart"+d+" click"+d);b&&z.off("touchmove"+d+" touchend"+d)}})();N()})(window.jQuery||window.Zepto);
...
function k(){try{return b.activeElement}catch(a){}}var f="placeholder"in b.createElement("input"),p="placeholder"in b.createElement("textarea"),q=c.fn,z=c.valHooks,v=c.propHooks;f&&p?(q=q.placeholder=function(){return this},q.input=q.textarea=!0):(q=q.placeholder=function(){this.filter((f?"textarea":":input")+"[placeholder]").not(".placeholder").bind({"focus.placeholder":e,"blur.placeholder":g}).data("placeholder-enabled",!0).trigger("blur.placeholder");return this},q.input=f,q.textarea=p,q={get:function(a){var b=
c(a),d=b.data("placeholder-password");return d?d[0].value:b.data("placeholder-enabled")&&b.hasClass("placeholder")?"":a.value},set:function(a,b){var d=c(a),f=d.data("placeholder-password");if(f)return f[0].value=b;if(!d.data("placeholder-enabled"))return a.value=b;""==b?(a.value=b,a!=k()&&g.call(a)):d.hasClass("placeholder")?e.call(a,!0,b)||(a.value=b):a.value=b;return d}},f||(z.input=q,v.value=q),p||(z.textarea=q,v.value=q),c(function(){c(b).delegate("form","submit.placeholder",function(){var a=
...
jQuery(document).find("#td-mobile-nav .menu-item-has-children").each(function(a){a="td_mobile_elem_with_submenu_"+a;jQuery(this).addClass(a);jQuery(this).children("a").addClass("td-link-element-after");jQuery(this).click(function(a){var c=jQuery(a.target);
...
(function(){tdAjaxSearch={_current_selection_index:0,_last_request_results_count:0,_first_down_up:!0,_is_search_open:!1,init:function(){
jQuery("#td-header-search-button").click(function(a){a.preventDefault();!0===tdAjaxSearch._is_search_open?tdAjaxSearch.hide_search_box():tdAjaxSearch.show_search_box()});
...
return!0})},show_search_box:function(){jQuery(".td-drop-down-search").addClass("td-drop-down-search-open");!0!==tdDetect.isIos;tdAjaxSearch._is_search_open=!0},hide_search_box:function(){jQuery(".td-drop-down-search").removeClass("td-drop-down-search-open");tdAjaxSearch._is_search_open=!1},td_aj_search_move_prompt_up:function(){!0===tdAjaxSearch._first_down_up?(tdAjaxSearch._first_down_up=!1,0===tdAjaxSearch._current_selection_index?
...
"data-effect":"mpf-td-login-effect"}),jQuery(".comment-reply-login, .td-login-modal-js, .td-keyword-modal-js, .td-coupon-modal-js").magnificPopup(a));jQuery(".td-login-modal-js, .comment-reply-login, .td-keyword-modal-js, .td-coupon-modal-js").on("click",function(a){750>jQuery(window).width()&&void 0!==window.tds_login_sing_in_widget&&(a.preventDefault(),jQuery("body").addClass("td-menu-mob-open-menu"),jQuery(".td-mobile-container").hide(),jQuery("#td-mobile-nav").addClass("td-hide-menu-content"),setTimeout(function(){jQuery(".td-mobile-container").show()},500),tdLogin.showHideElementsMobile([["#td-login-mob",
1],["#td-register-mob",0],["#td-forgot-pass-mob",0]])
)});
jQuery(".td-keyword-modal-js").on("click",function(a){
jQuery("body").removeClass("td-menu-mob-open-menu");
jQuery(".td-mobile-container").hide();
a.preventDefault();
});
jQuery(".td-coupon-modal-js").on("click",function(a){
jQuery("body").removeClass("td-menu-mob-open-menu");
jQuery(".td-mobile-container").hide();
a.preventDefault();
});
...
d.outerHeight(!0)/2,k=0,k=e.length?e.outerHeight(!0):0;k>g&&(g=k);0>g?g=0:a(window).height()-d.outerHeight(!0)/2<b.pageY-document.body.scrollTop&&(g=a(window).height()-d.outerHeight(!0));d.css("top",g)},_resetTdScreeDemoExtendWidth:function(){var b=parseInt(a("#td-theme-settings").css("width").replace("px",""))/2;a(".td-screen-demo-extend:first").css({width:b+"px"})},_showExtendedScreenDemo:function(){tdDemoMenu._extendedDemo&&a(".td-screen-demo-extend:first").css({top:a(".td-screen-demo:first").css("top")}).show()},
...
a)?f.sidebar_state="case_4_fixed_up":"up"===d&&!0===tdSmartSidebar._is_smaller_or_equal(g,f.sidebar_top)&&(f.sidebar_state="case_2_top_of_content"),"case_1_fixed_down"===f.sidebar_state&&"up"===d||"case_4_fixed_up"===f.sidebar_state&&"down"===d)f.sidebar_state="case_5_absolute";var p=0,q=tdViewport.getCurrentIntervalItem();null!==q&&(p=q.sidebarWidth);switch(f.sidebar_state){case "case_1_fixed_down":if(!0===f.case_1_run_once)break;tdSmartSidebar.log("sidebar_id: "+k+" "+f.sidebar_state);f.case_1_run_once=
...
var Froogaloop=function(){function a(b){return new a.fn.init(b)}function b(a,b,c){if(!c.contentWindow.postMessage)return!1;var d=c.getAttribute("src").split("?")[0];a=JSON.stringify({method:a,value:b});"//"===d.substr(0,2)&&(d=window.location.protocol+d);c.contentWindow.postMessage(a,d)}function c(a){var b,c;try{b=JSON.parse(a.data),c=b.event||b.method}catch(d){}"ready"==c&&!g&&(g=!0);if(a.origin!=k)return!1;a=b.value;var z=b.data,v=""===v?null:b.player_id;b=v?e[v][c]:e[c];c=[];if(!b)return!1;void 0!==
a&&c.push(a);z&&c.push(z);v&&c.push(v);return 0<c.length?b.apply(null,c):b.call()}function d(a,b,c){c?(e[c]||(e[c]={}),e[c][a]=b):e[a]=b}var e={},g=!1,k="";a.fn=a.prototype={element:null,init:function(a){"string"===typeof a&&(a=document.getElementById(a));this.element=a;a=this.element.getAttribute("src");"//"===a.substr(0,2)&&(a=window.location.protocol+a);a=a.split("/");for(var b="",c=0,d=a.length;c<d;c++){if(3>c)b+=a[c];else break;2>c&&(b+="/")}k=b;return this},api:function(a,c){if(!this.element||
!a)return!1;var e=this.element,g=""!==e.id?e.id:null,k=c&&c.constructor&&c.call&&c.apply?null:c,r=c&&c.constructor&&c.call&&c.apply?c:null;r&&d(a,r,g);b(a,k,e);return this},addEvent:function(a,c){if(!this.element)return!1;var e=this.element,k=""!==e.id?e.id:null;d(a,c,k);"ready"!=a?b("addEventListener",a,e):"ready"==a&&g&&c.call(null,k);return this},removeEvent:function(a){if(!this.element)return!1;var c=this.element,d;a:{if((d=""!==c.id?c.id:null)&&e[d]){if(!e[d][a]){d=!1;break a}e[d][a]=null}else{if(!e[a]){d=
...
tdAnimationStack._initialize_item(c);d.push(c)});(function(){for(var a=!0,k=0;k<d.length;k++)if(!1===e[k].complete){a=!1;break}if(!1===a){var f=(new Date).getTime();tdAnimationStack.log("TIMER - started");var p=setInterval(function(){var k=0;if((new Date).getTime()-f>tdAnimationStack.max_waiting_for_init)for(clearInterval(p),k=0;k<d.length;k++)d[k].jqueryObj.removeClass(tdAnimationStack._animation_css_class1),d[k].jqueryObj.addClass(tdAnimationStack._animation_css_class2);else{a=!0;for(k=0;k<d.length;k++)if(!1===
