$(document).ready(function () {
    ...
    function switchTheme(themeName) {
        ...
        if (themeName == 'theme_default') {
            $('#bs-css').attr('href', __cfg('path_absolute')+'assets/customer/css/theme_default.css');
        }
		else if (themeName == 'classic') {
            $('#bs-css').attr('href', __cfg('path_absolute')+'assets/customer/css/bootstrap.min.css');
        }
		else {
            $('#bs-css').attr('href', __cfg('path_absolute')+'assets/customer/css/bootstrap-' + themeName + '.min.css');
        }
