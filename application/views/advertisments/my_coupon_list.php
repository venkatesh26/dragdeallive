...
$coupon_list=getHomeCouponlist($user_id);
?>
...
<div class="td-pb-span12 td-main-content home-coupon-list">
 <h4 class=block-title><span>Coupons of the day</span> <a class="view-all-button" href="<?php echo base_url().'coupons?add_id='.$coupon_list[0]['advertisement_id'];?>"> View all</a></h4>
