     <div id="comments" class="comments">
                            <div class="comment-respond" id="respond">
                                <h3 class="comment-reply-title" id="reply-title">Review <?php echo ucwords($result['name']);?></h3>
                                <form class="comment-form" id="user-add-comment" method="post" action="<?php echo base_url().'comments/add_comment';?>">
