...
<h4 class="block-title"><span>Send Enquiry to <?php echo ucwords($title);?></span></h4>
</div>
</div>
<div role="form" class="wpcf7" lang="en-US" dir="ltr">
<div class="screen-reader-response"></div>
<form action="<?php echo base_url().'home/enquiry?token='.$advertisment_id;?>" method="post"  id="new_enquiry_form_url_popup1">
...
<p><span class="wpcf7-form-control-wrap"><input type="text" name="contact_no" value="" placeholder="Enter Your Contact No *" size="40" aria-required="true" aria-invalid="false"></span></p>

<p><span class="wpcf7-form-control-wrap"><input type="text" name="title" value="" placeholder="Enter Enquiry Title *" size="40" aria-required="true" aria-invalid="false"></span></p>

<input class="enquiry_advertisment_id" type=hidden name=advertisment_id  value="<?php echo $advertisment_id;?>" id="enquiry_advertisment_id">
<input class="advertisment_email" type=hidden name=advertisment_email  value="<?php echo $advertisment_email;?>" id="advertisment_email">
<input class="advertisment_user_id" type=hidden name=advertisment_user_id  value="<?php echo $advertisment_user_id;?>" id="advertisment_email">
