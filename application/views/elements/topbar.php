    			...
    			<i class="fa fa-bars"></i>
                    ...
                    <div class="header-block header-block-buttons">
					   ...
					   $style='';
						...
						<?php if($addId==0 || $addId==null):?>
						<a title="My Bussiness Already Registed I Just Want Claim it." href="<?php echo base_url().'bussiness-claims';?>" class="btn btn-sm rounded-s header-btn"> <i class="fa fa-briefcase"></i> My Bussiness Already Registed</a>	
						<?php endif;?>
                    </div>
