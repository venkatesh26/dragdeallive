   ...
   <div class="sidebar-container">
      ...
      <nav class="menu">
         <ul class="nav metismenu" id="sidebar-menu">
            ...
            <li class="<?php if($this->uri->segment('1')=='business-profile' || $this->uri->segment('1')=='gallery' || $this->uri->segment('1')=='business-enquires' || $this->uri->segment('1')=='my-orders' || $this->uri->segment('1')=='business-reviews' || $this->uri->segment('1')=='my-plans') { echo "active open";}?>">
               <a href=""> <i class="fa fa-briefcase"></i> Manage Bussiness <i class="fa arrow"></i> </a>
               <ul>
