   ...
   <div class="title-search-block">
      ...
      <div class="title-block1">
         <div class="row">
            <div class="col-md-6">
               <h3 class="title">
                  <i class="fa fa-comments-o"></i> Bussiness Enquires List
               </h3>
         ...
         <li class="item item-list-header hidden-sm-down td-header-bar">
            <div class="item-row">
               ...
               <div class="item-col item-col-header item-col-date">
                  <div> <span><i class="fa fa-calendar"></i> Enquiry Date</span> </div>
               </div>
...
<script>
   var url="<?php echo base_url();?>"+'customers/enquiry_list';
   function getallOrdersList(url){
    ...
    function changeStatus(id,status){
		...
		$.ajax({
			type: "POST",
			url: 'customers/change_enquiry_status',
			datatype:"json",
			async:true,
   ...
   $(document).ready(function(){
		...
		$('.enquiry_detail').livequery('click',function(){
...
<div class="modal fade" id="enquiry-detail-modal">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<h4 class="modal-title"><i class="fa fa-comment"></i> Enquiry Detail</h4> </div>
			<div class="modal-body">
			<div class="row">
					<fieldset>
