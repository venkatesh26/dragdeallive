         ...
         <li class="item">
            <div class="item-row">
               ...
               <div class="item-col fixed item-col-title">
                  ...
                  <div class="no-overflow"> <i class="fa fa-user"></i> <?php echo ucwords($list['buyer_name']);?><br/>
				  <?php if($list['buyer_email']!=''):?>
					<i class="fa fa-envelope"></i> <?php echo ucwords($list['buyer_email']);?>
                  <?php endif;?>
				  </div>
               </div>
