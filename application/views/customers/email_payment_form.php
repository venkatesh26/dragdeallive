...
paymentsSave($txnid, $user_id , 1);
$posted = array();
$posted['amount']=number_format($no_of_months * $plan_details['price'], 2, '.', '');
if($plan_details['id']==1){
	$posted['amount']=number_format($plan_details['price'], 2, '.', '');
}
$posted['email']=$user_profile_info['email'];
...
$posted['surl']=base_url().'home/payu_success';
$posted['furl']=base_url().'home/payu_failure';
$posted['address1']=(isset($user_profile_info['address']) ) ? $user_profile_info['address'] : '';
$posted['address2']='';
$posted['zipcode']='';
$posted['country']='';
$posted['udf1']=$user_id;
$posted['udf2']=$plan_details['id'];
