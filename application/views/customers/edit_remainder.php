				...
				<div class="card">
				   ...
				   <form id="birthday_campaings_form_url" action="<?php echo base_url().'remainder_edit/'.$edit_id.'/'.$type;?>" method="post">
					...
					<label class="control-label1" for="message">Message <span style="color:red;">*</span>
							...
							<div class="form-group col-md-4">
								<label class="control-label" for="url">Campaing Url <span style="color:red;">*</span> </label>
								<input type="text" name="url" class="form-control" id="url" value="<?php echo $edit_info['url'];?>">
							</div>
							<div class="form-group col-md-8"> 
								<label>Select Option&nbsp;&nbsp;</label>
								<div class="filter_type_code">
									<input type="radio" name="coupon_type" rel="1" id="filter_type_code" class="clearfix cursor" <?php if($edit_info['coupon_type']==1){ echo "checked=checked";}?> value="1"> Dynamic Coupon Code  &nbsp;&nbsp;&nbsp;&nbsp;
									<input type="radio" name="coupon_type"  <?php if($edit_info['coupon_type']==2){ echo "checked=checked";}?> rel="2" id="filter_type_code" class="clearfix cursor" value="2"> Static Coupon Code &nbsp;&nbsp;&nbsp;&nbsp;
									<input type="text" maxlength="6" name="coupon_code" id="coupon_code" placeholder="Enter Coupon Code" style="display:none;">
								</div>
							</div>										
