	...
	<div class="col-md-12">
		<div class="col-md-9 card card-block" style="height:80px;padding-top:25px;margin-top:10px">
			<div>
				...
				<?php if($dashboardData['plan_name']!='basic' && $dashboardData['is_one_time']==false):?>
...
<script>
   $(document).ready(function() {
		...
		$('.profile_plan').livequery('click',function(){
			
			window.location.href=__cfg('path_absolute')+'business-profile?plan_id='+$(this).attr('rel')+'&no_of_months='+$('#plan_months').val();	
		});
