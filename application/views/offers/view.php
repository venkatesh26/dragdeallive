                  ...
                  <div id="divOfferStoreDetails2" class="col-md-5 boxWhite" style="display:inline-block;margin-top:10px;">
                     ...
                     <div class="td-post-sharing td-post-sharing-top">
                        <div class="td-default-sharing">
                           ...
                           <a onclick="window.open(this.href, 'mywin','left=50,top=50,width=600,height=350,toolbar=0'); return false;" href="http://www.linkedin.com/shareArticle?mini=true&url=<?php echo $share_link;?>&title=<?php echo ucwords($result['title']);?>&summary=&source=<?php echo base_url();?>" class="td-social-sharing-buttons td-social-pinterest"><i class="fa fa-linkedin"></i></a>
                        </div>
                     </div>
                  </div>
