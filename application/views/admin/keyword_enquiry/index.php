						  ...
						  <table class="table table-striped table-bordered" id="rowclick1">
							...
							?>
							  <tr class="check-select">
								...
								<td class="td-actions">
								<?php 
								echo anchor(base_url().ADMIN.'/keyword_enquiry/view/'.$vals['id'].'?pagemode='.$pagestatus.'&modestatus='.$pagingstatus.'&sortingfied='.$fieldssort.'&sortype='.$ordersort,'<i class="btn-icon-only icon-list-alt"> </i>',array('class'=>'btn btn-medium','title'=>'View'));
								echo anchor(base_url().ADMIN.'/keyword_enquiry/delete/'.$vals['id'].'?pagemode='.$pagestatus.'&modestatus='.$pagingstatus.'&sortingfied='.$fieldssort.'&sortype='.$ordersort,'<i class="btn-icon-only icon-trash"> </i>',array('class'=>'btn btn-big delete-con','title'=>'Delete'));
								?>
								</td>
							  </tr>
							<?php }
