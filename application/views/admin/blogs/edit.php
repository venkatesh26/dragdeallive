	      		...
	      		<div class="widget ">
					...
					<div class="widget-content">
						<div class="tabbable">
							...
							echo form_open_multipart(ADMIN.'/blogs/edit/'.$blogs['id'].'?pagemode='.$this->input->get('pagemode').'&modestatus='.$this->input->get('modestatus').'&sortingfied='.$this->input->get('sortingfied').'&sortype='.$this->input->get('sortype'), $attributes);
							?>
								<fieldset>
									<br/>
									<div class="control-group">											
										...
										<div class="controls">
										<?php echo form_input(array('name'=>'name','class'=> 'span3','id'=>'name','value'=>set_value('name', $this->input->post('name') ? $this->input->post('name') : $blogs['name'])),$this->input->post('name')); ?>
									...
									<div class="control-group">											
										...
										<div class="controls">
										<?php echo form_textarea(array('name'=>'short_description','class'=> 'span3','id'=>'short_description','style'=>'width:700px;','value'=>set_value('name', $this->input->post('short_description') ? $this->input->post('short_description') : $blogs['short_description'])),$this->input->post('short_description')); ?>
									...
									<div class="control-group">											
										...
										<div class="controls">
										<?php
										$txtattribute = array('name'=>'description','id'=>'description','value'=>set_value('description', $this->input->post('description') ? $this->input->post('description') : $blogs['description']));
									...
									<div class="control-group">											
										...
										<div class="controls">
									<?php echo form_dropdown("blog_category_id",array(""=>"Select Category")+$categories,$this->input->post('blog_category_id') ? $this->input->post('blog_category_id') :$blogs['blog_category_id'],'id="blog_category_id"'); ?>								
	                               ...
	                               <div class="control-group">											
										...
										<div class="controls">
										<?php echo form_input(array('name'=>'meta_keywords','class'=> 'span3','id'=>'meta_keywords','value'=>set_value('meta_keywords',$this->input->post('meta_keywords') ? $this->input->post('meta_keywords') : $blogs['meta_keywords'])),$this->input->post('meta_keywords')); ?>
                                    ...
                                    <div class="control-group">											
										...
										<div class="controls">
										<?php echo form_textarea(array('name'=>'meta_description','class'=> 'span3','id'=>'name','value'=>set_value('meta_description',$this->input->post('meta_description') ? $this->input->post('meta_description') : $blogs['meta_description']),'style'=>'width:700px;'),$this->input->post('meta_description')); ?>
