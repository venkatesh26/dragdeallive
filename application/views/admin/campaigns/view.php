						...
						<div class="tabbable">
							<div class="tab-pane form-horizontal" id="formcontrols">
								<fieldset>
									...
									<div class="widget-header listpadd" >Details Informations	</div>
									<br/>
									
									<div class="control-group views1">											
										<label class="control-label" for="username">No. Of User Send :</label>
										<div class="controls views">
											<?php 
			
											echo ucwords($campaign['number_of_user_send']);  ?>
										</div> <!-- /controls -->				
									</div> <!-- /control-group -->
									
										<div class="control-group views1">											
										<label class="control-label" for="username">No. Of User Recived :</label>
										<div class="controls views">
											<?php 
		
											echo ucwords($campaign['number_of_user_received']);  ?>
										</div> <!-- /controls -->				
									</div> <!-- /control-group -->
							
									<div class="control-group views1">											
										<label class="control-label" for="username">No. Of User Open :</label>
										<div class="controls views">
											<?php 

											echo ucwords($campaign['number_of_user_opened']);  ?>
										</div> <!-- /controls -->				
									</div> <!-- /control-group -->
