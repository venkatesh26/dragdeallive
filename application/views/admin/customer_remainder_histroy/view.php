							...
							<div class="tab-pane form-horizontal" id="formcontrols">
								<fieldset>
									...
									if(isset($_GET['pagemode'])) {
										echo anchor(base_url().ADMIN.'/customer_remainder_histroy/'.$this->input->get('pagemode').'/'.$this->input->get('modestatus').'/'.$this->input->get('sortingfied').'/'.$this->input->get('sortype'),'<i class="icon-step-backward "></i> &nbsp;&nbsp; Go Back'); 
										} else {
									...
									<div class="control-group views1">											
										...
										<div class="controls views">
											...
											<div class="control-group views1">											
										<label class="control-label" for="username">No Of SMS Send :</label>
										<div class="controls views">
											<?php echo ucwords($campaign['number_of_user_send']);  ?>
										</div> <!-- /controls -->				
									</div> <!-- /control-group -->
											...
											<div class="control-group views1">											
										<label class="control-label" for="username">No Of SMS Recived :</label>
										<div class="controls views">
											<?php echo ucwords($campaign['number_of_user_received']);  ?>
										</div> <!-- /controls -->				
									</div> <!-- /control-group -->
									...
									<div class="control-group views1">											
										<label class="control-label" for="username">No Of Sms Debit :</label>
										<div class="controls views">
											<?php echo ucwords($campaign['number_of_sms_debit']);  ?>
										</div> <!-- /controls -->				
									</div> <!-- /control-group -->
