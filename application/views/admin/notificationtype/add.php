	      		...
	      		<div class="widget ">
					...
					<div class="widget-content">
						<div class="tabbable">
							...
							echo form_open_multipart(ADMIN.'/notification_type/add?pagemode='.$this->input->get('pagemode').'&modestatus='.$this->input->get('modestatus').'&sortingfied='.$this->input->get('sortingfied').'&sortype='.$this->input->get('sortype'), $attributes);
							?>
								<fieldset>
									<br/>
									<div class="control-group">											
										...
										<div class="controls">
										<?php echo form_input(array('name'=>'code','class'=> 'span3','id'=>'code'),$this->input->post('code')); ?>
									...
									<div class="control-group">											
										...
										<div class="controls">
										<?php echo form_input(array('name'=>'template_title','class'=> 'span3','id'=>'template_title'),$this->input->post('template_title')); ?>
									...
									<div class="control-group">											
										...
										<div class="controls">
										<?php echo form_textarea(array('name'=>'template','rows'=>5,'class'=> 'span5','id'=>'template'),$this->input->post('template')); ?>
