      ...
      <ul class="item-list striped">
         <li class="item item-list-header hidden-sm-down td-header-bar">
            <div class="item-row">
               ...
               <div class="item-col item-col-header item-col-author" style="padding-left:90px;">
                  <div> <span><i class="fa fa-clock-o"></i> Type</span> </div>
               </div>
               <div class="item-col item-col-header item-col-title" style="padding-left:40px;">
                  <div class=""> <span><i class="fa fa-clock-o"></i> Period</span> </div>
               </div>
               <div class="item-col item-col-header item-col-author">
                  <div class="no-overflow"> <span> <i class="fa fa-clock-o"></i> Status</span> </div>
               </div>
