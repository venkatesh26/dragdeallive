...
<article class="content dashboard-page white-bg-art">
               ...
               <div class="card-block">
                  <div class="tab-content">
                     <div role="tabpanel" class="tab-pane fade active in" id="visits">
                        <p class="title-description">  Last 10 days Sms Send <span class="sms_chart no_sms_data" style="display:none;color:red;"> - No Data Found <span> </p>
      ...
      <div class="row sameheight-container">
         <div class="col-xl-4">
            <div class="card sameheight-item sales-breakdown green-border-box" data-exclude="xs,sm,lg">
               ...
               <div class="card-block">
                  <div class="dashboard-sales-breakdown-chart" id="dashboard-today-sms-send" rel="<?php echo $sms_info['today_send_sms_count'];?>"></div>
         ...
         <div class="col-xl-4">
            <div class="card sameheight-item sales-breakdown green-border-box" data-exclude="xs,sm,lg">
               ...
               <div class="card-block">
                  <div class="dashboard-sales-breakdown-chart" id="dashboard-lastmonth-total-sms-send" rel="<?php echo $sms_info['month_send_sms_count'];?>"></div>
		 ...
		 <div class="col-xl-4">
            <div class="card sameheight-item sales-breakdown green-border-box"  data-exclude="xs,sm,lg">
               <div class="card-header">
                  <div class="header-block">
                     <h3 class="title">
                      <i class="fa fa-thumbs-o-up green-font-icon"></i>&nbsp;    Total Sms Sent
                     </h3>
                  </div>
               </div>
               <div class="card-block">
                  <div class="dashboard-sales-breakdown-chart" id="dashboard-total-sms-send" rel="<?php echo $sms_info['total_number_of_sms_send'];?>"></div>
				  <span class="sms_chart no_total_smsfound_view" style="color: red;display:none;"> No Data Found <span></span></br></span>
               </div>
            </div>
         </div>
      </div>
   ...
   <div class="title-search-block">
      <div class="title-block1">
         <div class="row">
            <div class="col-md-12">
               <h3 class="title">
                  <i class="fa fa-comments-o green-font-icon"></i> Latest Sms Campaign Histroy
               </h3>
               <br/>
            </div>
         </div>
         ...
         <li class="item item-list-header hidden-sm-down td-header-bar">
            <div class="item-row">
               ...
               <div class="item-col item-col-header item-col-category">
                  <div> <span><i class="fa fa-arrow-up"></i> Status</span> </div>
               </div>
			    <div class="item-col item-col-header item-col-date">
    ...
    <div class="title-search-block">
      <div class="title-block1">
         <div class="row">
            <div class="col-md-12">
               <h3 class="title">
                  <i class="fa fa-signal green-font-icon"></i> Latest Campaign Track List
               </h3>
   ...
   <div class="card items">
      <ul class="item-list striped">
         <li class="item item-list-header hidden-sm-down td-header-bar">
            <div class="item-row">
               ...
               <div class="item-col item-col-header item-col-title">
                  <div class=""> <span><i class="fa fa-group"></i>  Customer Name</span> </div>
               </div>
			    <div class="item-col item-col-header item-col-date">
                  <div class=""> <span><i class="fa fa-list-alt"></i>  Visit Count</span> </div>
               </div>
			    <div class="item-col item-col-header item-col-date">
                  <div> <span><i class="fa fa-calendar"></i>  Date</span> </div>
               </div>
	  ...
	  <ul class="item-list striped js-new-response">
	  
	  </ul>
   </div>
   <nav class="text-xs-right js-new-pagenation">
...
<script>
   var url="<?php echo base_url();?>"+'reports/my_campaign_data';
   var url1="<?php echo base_url();?>"+'reports/my_campaign_tracklist';
	...
	$.LoadingOverlay("show");
   	$.ajax({
   		...
   		success: function(data) {
			$.LoadingOverlay("hide");
			var data=jQuery.parseJSON(data);
			$('.js-new-response').html(data.main_content);
			$('.js-new-pagenation').html(data.pagination_link);
   		}
   	});
   }
   ...
   $(document).ready(function() {
		getallList(url);
		gettrackList(url1);
		$('.js-pagenation .page-item a').livequery('click',function(){
			getallList($(this).attr('href'));
			return false;
		});
		
		$('.js-new-pagenation .page-item a').livequery('click',function(){
			gettrackList($(this).attr('href'));
			return false;
		});
