<article class="content items-list-page content dashboard-page">
	...
	<?php echo $this->load->view('advertisments_customer_bills/order_info',array(),true);?>
                     ...
                     <form name="search-stat" id="search-users">
                        <div class="col-md-12">
						   ...
						   <div class="col-md-2">
                              ...
                              <input type="text" name="s_mobile_number" class="date form-control" id="s_mobile_number">
                           </div>
...
<script>
   var url="<?php echo base_url();?>"+'advertisments_customer_bills/index';
