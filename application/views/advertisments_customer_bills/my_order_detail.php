<article class="content items-list-page content dashboard-page">
 ...
 <div class="row">
  <br/>
                  <h3 class="title">
                     <i class="fa fa-user-md"></i> Shop Details
                  </h3>	
				  <br/>
               ...
               <fieldset>
			     <?php if($order_detail['shop_name']!=''):?>	
                  <div class="control-group views1">
                     <label class="control-label" for="username">Shop Name :</label>
                     <div class="controls views first_name"><?php echo ucwords($order_detail['shop_name']);?></div>
                  </div>
				  <?php endif;?>
				  <?php if($order_detail['contact_phone_number']!=''):?>	
				    <div class="control-group views1">
                     <label class="control-label" for="username">Contact Phone Number : </label>
                     <div class="controls views first_name"><?php echo ucwords($order_detail['contact_phone_number']);?></div>
                  </div>
				  <?php endif;?>
				  
				  	  <?php if($order_detail['contact_address']!=''):?>	
				  <div class="control-group views1">
                     <label class="control-label" for="username">Conatct Address : </label>
                     <div class="controls views posted_date"><div class="no-overflow">   <i class="fa fa-phone"></i> <?php echo ucwords($order_detail['contact_address']);?><br/></div></div>
                  </div>
				  <?php endif;?>
