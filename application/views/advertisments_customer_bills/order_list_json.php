	...
	<li class="item">
		<div class="item-row">
		   <div class="item-col item-col-newtitle">
			  ...
			  <div class="no-overflow"> <?php echo Ucfirst($list['first_name'])." ".Ucfirst($list['last_name']);?>  </div>
		   </div>
		     <div class="item-col item-col-newtitle">
			  <div class="item-heading">Mobile Number</div>
			  <div class="no-overflow">   <i class="fa fa-phone"></i> <?php echo ucwords($list['mobile_number']);?><br/>
			  ...
			  <div class="item-actions-dropdown">
				 ...
				 <div class="item-actions-block">
					<ul class="item-actions-list">
					   <li>
						  <a class="remove order_detail" target="_blank" href="<?php echo base_url().'advertisments_customer_bills/view/'.$list['id'];?>"> <i class="fa fa-list-alt"></i> </a>
					   </li>
					</ul>
				 </div>
			  </div>
