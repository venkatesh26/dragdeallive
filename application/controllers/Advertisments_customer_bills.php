...
class Advertisments_customer_bills extends CI_Controller {
	...
	public function my_order_detail($id){
		...
		$this->breadcrumbs->push($this->site_name,base_url());		
		$this->breadcrumbs->push('Order Detail',base_url());
		$this->data['order_detail']=$this->Advertisment_customers_bills_model->my_order_detail($id, $this->session->userdata('customer_id'));		
		$this->data['main_content']=$this->load->view('advertisments_customer_bills/my_order_detail', $this->data,true);
		$this->load->view('layouts/customer', $this->data);	
	}
	...
	public function my_bills(){
		...
		$this->data['title_of_layout']=$this->site_name." - ".'My Bills';
		...
		$config['base_url'] = base_url().'advertisments_customer_bills/my_bills';
		$config['first_url'] = base_url().'advertisments_customer_bills/my_bills';
		...
		$order_list=$this->Advertisment_customers_bills_model->getMyOrderList($this->session->userdata('customer_id'),$limit_start,$limit_end);	
		...
		$this->data['main_content']=$this->load->view('advertisments_customer_bills/bill_list_json', $this->data,true);
		echo json_encode($this->data);
		die;
		} else {
			$this->data['main_content']=$this->load->view('advertisments_customer_bills/bill_list', $this->data,true);
			$this->load->view('layouts/customer', $this->data);	
		}
